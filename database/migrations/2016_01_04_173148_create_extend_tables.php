...
return new class extends Migration
{
    ...
    {
        return config('extend.database.connection') ?: config('database.default');
    }
    ...
    public function up()
    {
        Schema::create(config('extend.database.channel_table'), function (Blueprint $table) {
        ...
        Schema::create(config('extend.database.role_channel_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
        ...
        Schema::create(config('extend.database.channel_server_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('channel_id')->unsigned()->default(0)->comment('渠道ID');
        ...
        Schema::create(config('extend.database.server_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
        ...
        Schema::create(config('extend.database.role_server_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('role_id')->unsigned()->default(0)->comment('角色ID');
            $table->integer('server_id')->unsigned()->default(0)->comment('服务器ID');
            $table->integer('created_time')->unsigned()->default(0)->comment('创建时间');
        ...
        Schema::create(config('extend.database.configure_file_table'), function (Blueprint $table) {
        ...
        Schema::create(config('extend.database.configure_table_table'), function (Blueprint $table) {
            $table->integer('id')->comment('')->autoIncrement();
        ...
        Schema::create(config('extend.database.import_log_table'), function (Blueprint $table) {
            $table->integer('id')->comment('')->autoIncrement();
            $table->string('table_schema')->default('')->comment('数据库');
            $table->string('table_name')->default('')->comment('表');
            $table->string('table_comment')->default('')->comment('注释');
        ...
        Schema::create(config('extend.database.user_manage_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('user_id')->unsigned()->default(0)->comment('用户id');
            $table->json('servers')->default('')->comment('服务器列表');
        ...
        Schema::create(config('extend.database.user_chat_manage_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('user_id')->unsigned()->default(0)->comment('用户id');
            $table->json('servers')->default('')->comment('服务器列表');
            $table->json('roles')->default('')->comment('角色列表');
        ...
        Schema::create(config('extend.database.mail_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('user_id')->unsigned()->default(0)->comment('用户id');
            $table->json('servers')->default('')->comment('服务器列表');
            $table->json('roles')->default('')->comment('角色列表');
        ...
        Schema::create(config('extend.database.notice_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
            $table->integer('user_id')->unsigned()->default(0)->comment('用户id');
            $table->json('servers')->default('')->comment('服务器列表');
        ...
        Schema::create(config('extend.database.ssh_key_table'), function (Blueprint $table) {
            $table->integer('id')->unsigned()->comment('')->autoIncrement();
    ...
    {
        Schema::dropIfExists(config('extend.database.channel_table'));
        Schema::dropIfExists(config('extend.database.role_channel_table'));
        Schema::dropIfExists(config('extend.database.server_table'));
        Schema::dropIfExists(config('extend.database.role_server_table'));
        Schema::dropIfExists(config('extend.database.configure_table_table'));
        Schema::dropIfExists(config('extend.database.configure_file_table'));
        Schema::dropIfExists(config('extend.database.import_log_table'));
        Schema::dropIfExists(config('extend.database.ssh_key_table'));
    }
};
