...
class UserModel extends Model implements AuthenticatableContract
{
     ...
     * @var array
     */
    protected $with = ['permissions', 'roles', 'roles.permissions'];
    ...
    {
        return $this->belongsToMany(PermissionModel::class, config('admin.database.user_permission_table'), 'user_id', 'id');
    }

    public function roles(): BelongsToMany
    {
        return $this->belongsToMany(RoleModel::class, config('admin.database.user_role_table'), 'user_id', 'id');
    }
}
