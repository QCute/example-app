...
class AssetConsumeModel extends DistributionModel
{
    /**
     ...
     * @var string
     */
    protected $table = 'asset_consume_log';

    public static function getRate(int $begin, int $end, string $asset = NULL): Collection
    {
        $model = new static();
        $assetData = $model
            ->getConnection()
