...
class UserChatManageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $columns = Schema::connection('extend')->getColumns(config('extend.database.user_chat_manage_table'));
    ...
    public function create(Request $request)
    {
        ...
        $options = [
            'SERVER' => trans('admin.time.current') . trans('admin.word.gap') . trans('admin.server'),
            'CHANNEL' => trans('admin.time.current') . trans('admin.word.gap') . trans('admin.channel'),
            'ALL' => trans('admin.all'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        switch($server) {
            ...
            default: {
                return ['code' => 1, 'msg' => 'Invalid server'];
            };
        }
        ...
        try {
            ...
            MachineService::send($servers, $command, $data);
