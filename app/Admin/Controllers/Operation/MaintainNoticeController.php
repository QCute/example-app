...
use App\Admin\Models\Operation\MaintainNoticeModel;
...
class MaintainNoticeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $columns = Schema::connection('api')->getColumns(config('api.database.maintain_notice_table'));
        ...
        $paginator = MaintainNoticeModel::getPage($page, $perPage, $input);
    ...
    public function store(Request $request)
    {
        ...
        MaintainNoticeModel::create($attributes);
    ...
    {
        $data = MaintainNoticeModel::find($id);
    ...
    {
        MaintainNoticeModel::destroy($id);
