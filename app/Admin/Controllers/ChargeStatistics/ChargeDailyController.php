...
class ChargeDailyController extends StatisticsController
{
    public function index(Request $request)
    {
        ...
        $header = collect([
            ...
            (new Header())->field('new_user')->title(trans("admin.statistics.new") . trans('admin.word.gap') . trans("admin.statistics.user"))->align(),
            (new Header())->field('new_times')->title(trans("admin.statistics.new") . trans('admin.word.gap') . trans("admin.statistics.times"))->align(),
            (new Header())->field('new_money')->title(trans("admin.statistics.new") . trans('admin.word.gap') . trans("admin.statistics.money"))->align(),
