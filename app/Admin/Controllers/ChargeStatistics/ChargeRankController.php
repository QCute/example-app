...
class ChargeRankController extends StatisticsController
{
    public function index(Request $request)
    {
        ...
        $header = collect([
            ...
            (new Header())->field('today_rank')->title(trans('admin.time.today') . trans('admin.word.gap') . trans('admin.statistics.rank'))->align(),
            (new Header())->field('today')->title(trans('admin.statistics.number'))->align(),
            (new Header())->field('total_rank')->title(trans('admin.statistics.number.total') . trans('admin.word.gap') . trans('admin.statistics.rank'))->align(),
