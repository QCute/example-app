...
use App\Admin\Models\ActiveStatistics\UserRegisterModel;
use Illuminate\Http\Request;

class UserRegisterController extends StatisticsController
{
    public function index(Request $request)
    {
        ...
        $data = ($end - $begin < 86400) ? UserRegisterModel::getDayAvg($begin, $end) : UserRegisterModel::getAvg($begin, $end);
