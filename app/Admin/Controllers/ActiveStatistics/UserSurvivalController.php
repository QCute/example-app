...
use App\Admin\Models\ActiveStatistics\UserSurvivalModel;
use Illuminate\Http\Request;

class UserSurvivalController extends StatisticsController
{
    public function index(Request $request)
    {
        ...
        $header = collect([
            ...
            (new Header())->field('number')->title(trans('admin.statistics.number'))->align()->width(120),
        ]);
