...
use App\Admin\Models\Statistics\AssetConsumeModel;
use Illuminate\Http\Request;

class AssetConsumeController extends StatisticsController
{
    public function index(Request $request)
    {
        ...
        $data = AssetConsumeModel::getRate($begin, $end, $asset);
