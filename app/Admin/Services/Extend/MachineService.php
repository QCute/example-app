...
class MachineService
{
     ...
     * @throws Exception
     */
    public static function repositoryStatus(ServerModel $server, string $path = null, string $output = 'stdout'): array
    {
        $status = '';
     ...
     * @throws Exception
     */
    public static function repositoryCommit(ServerModel $server, string $path = null): array
    {
     ...
     * @throws Exception
     */
    public static function executeMakerScript(ServerModel $server, array $command, string $path = null, string $output = 'stdout'): array
    {
     ...
     * @throws Exception
     */
    public static function executeRunScript(ServerModel $server, array $command, string $path = null, string $output = 'stdout'): array
    {
     ...
     * @throws Exception
     */
    public static function execute(ServerModel $server, array $command, string $path = null, string $output = 'stdout'): array
    {
        // server path as default
        $path = $path === '' ? $server->server_root : $path;
     ...
     * @throws Exception
     */
    public static function executeLocal(array $command, string $path = null, string $output = 'stdout'): array
    {
