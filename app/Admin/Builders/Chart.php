...
class Chart
{
    ...
    public function xAxis(string $type = 'category', array|Arrayable $default = null, array $options = []): static
    {
        if($type == 'category') {
    ...
    public function yAxis(string $type = 'value', array|Arrayable $default = null, array $options = []): static
    {
        if($type == 'category') {
            $data = collect($this->data);
            $data = $data->isEmpty() ? $default->toArray() : $data->pluck($this->key);
    ...
    public function grid(string $top = null, string $right = null, string $bottom = null, string $left = null, array $options = []): static
    {
        $this->option[__FUNCTION__] = [
            'top' => $top,
            'right' => $right,
    ...
    public function legend(string $top = null, string $right = null, string $bottom = null, string $left = null, array $options = []): static
    {
        $this->option[__FUNCTION__] = [
            'show' => true,
            'top' => $top,
