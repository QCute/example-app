    ...
    <div class="pear-container layui-row layui-col-space15">
        ...
        <div class="layui-col-md4">
            <div class="layui-card">
                <div class="layui-card-header">{{ trans('admin.environment') }}</div>
        ...
        <div class="layui-col-md4">
            <div class="layui-card">
                <div class="layui-card-header">{{ trans('admin.tips') }}</div>
                <div class="layui-card-body">
                <table class="layui-table" lay-skin="nob" lay-even>
                        <colgroup>
                            <col width="60" />
        ...
        <div class="layui-col-md4">
            <div class="layui-card">
                <div class="layui-card-header">{{ trans('admin.dependencie') }}</div>
                <div class="layui-card-body">
                    <table class="layui-table" lay-skin="nob" lay-even>
                        <colgroup>
                            <col width="60" />
